...
EXEC_GUI=test
MODULES_TEST=main_gui.c GUI.c control.c back_office.c IA.c
OBJECTS_TEST=main_gui.o GUI.o control.o back_office.o IA.o
#rules
...
main_gui.o: main_gui.c control.h GUI.h back_office.h
...
control.o: control.c control.h IA.h back_office.h GUI.h
